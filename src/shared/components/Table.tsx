...
export const Table = ({ children, className = '' }: { children: React.ReactNode; className?: string }) => (
  <div className={`w-full overflow-x-auto rounded-xl border border-zinc-800/80 bg-[#121214] ${className}`}>
...
export const Tr = ({ children, className = '' }: { children: React.ReactNode; className?: string }) => (
  <tr className={`hover:bg-[#18181b]/50 transition-colors ${className}`}>
    {children}
  </tr>
);
