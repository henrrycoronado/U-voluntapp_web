...
export const ProfileForm = () => {
  const { data: profile, loading: isLoadingProfile, updateProfile, isUpdating, error: profileError } = useMyProfile();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Error updating profile information.');
    }
  };
  ...
  return (
    <div className="p-4 md:p-10 w-full max-w-4xl mx-auto text-white animate-in fade-in duration-500">
      <div className="mb-10">
        ...
        <p className="text-zinc-400 text-sm">Manage your personal information and volunteer goals.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-2 text-yellow-500 mb-2">
                  ...
                  <h3 className="text-sm font-bold uppercase tracking-wider">Academic & Location</h3>
                </div>
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col gap-3 pt-6 border-t border-zinc-800/50 text-left">
              ...
              <div className="flex items-center gap-3 text-zinc-400">
                ...
                <span className="text-xs">
                  {careers?.find(c => c.uvaCode === profile?.careerCode)?.name || 'Career not set'}
                </span>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6 bg-zinc-900/30 border-zinc-800/50">
             <h4 className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-4">Account Status</h4>
