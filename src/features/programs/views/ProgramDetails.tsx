...
export const ProgramDetails = () => {
  ...
  if (isLoading)
    return (
      <div className="text-zinc-500 text-center py-20 text-white">Loading program details...</div>
    );
  if (!program)
    return <div className="text-zinc-500 text-center py-20 text-white">Program not found.</div>;

  return (
    <div className="p-4 md:p-10 w-full max-w-7xl mx-auto text-white">
      <button
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 text-zinc-400 hover:text-white mb-8 text-sm transition-colors"
      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-4 text-xs text-zinc-400">
                            ...
                            {activity.locationLatitude && (
                              <span className="flex items-center gap-1.5">
                                <MapPin size={14} className="text-yellow-500" /> Location Map
                              </span>
                            )}
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
                            View Details
                          </span>
                          <ExternalLink
                            size={16}
            ...
            <Card className="p-8 text-center flex flex-col items-center bg-[#18181b] border-yellow-500/10">
              ...
              <div className="mb-8">
                ...
                <p className="text-xs text-zinc-500">
                  Join this program to start contributing to your community and earning volunteer
                  hours.
                </p>
              </div>
            ...
            <Card className="p-6 bg-zinc-900/30 border-zinc-800/50">
              ...
              <ol className="text-xs text-zinc-400 space-y-4">
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-5 h-5 rounded-full bg-zinc-800 flex items-center justify-center text-white font-bold">
                    1
                  </span>
